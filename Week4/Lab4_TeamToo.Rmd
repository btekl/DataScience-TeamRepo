...
There are several variables within the babies data set that are not strongly connected to the smoking of the mother. Variables that we have found to be similar for parents who smoke and those who dont have been smoking to baby weight, gestation, race, age, height (for mother and father), and birthday of the baby.

```{r Team Plot, echo=TRUE, warning=FALSE}
ggplot(data = babies)+
  geom_bar(mapping = aes(x = bwtoz, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = gestation, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = mrace, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = mage, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = med, color = smoke))+
  facet_wrap(~smoke)
...
ggplot(data = babies)+
  geom_bar(mapping = aes(x = mpregwt, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = drace, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = dage, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = ded, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = dht, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = dwt, color = smoke))+
  facet_wrap(~smoke)

ggplot(data = babies)+
  geom_bar(mapping = aes(x = date, color = smoke))+
  facet_wrap(~smoke)
```
...
ggplot(data = babies, mapping = aes(x = mpregwt, y = gestation, color = Premature))+
  geom_point()
