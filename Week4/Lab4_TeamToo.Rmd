...
```{r}
cor.test(babies$smoke, babies$gestation)
cor.test(babies$smoke, babies$bwtoz)
cor.test(babies$smoke, babies$parity)
cor.test(babies$smoke, babies$mrace)
cor.test(babies$smoke, babies$mage)
cor.test(babies$smoke, babies$med)
cor.test(babies$smoke, babies$mht)
cor.test(babies$smoke, babies$mpregwt)
cor.test(babies$smoke, babies$drace)
cor.test(babies$smoke, babies$dage)
cor.test(babies$smoke, babies$ded)
cor.test(babies$smoke, babies$dht)
cor.test(babies$smoke, babies$dwt)
