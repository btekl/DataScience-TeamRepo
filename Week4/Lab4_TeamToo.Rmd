...
prem <- filter(babies,Premature==1,!is.na(smoke))
...
**The answer:** There are 194 premature births for which we have data on the mother's smoking habits, and in 103 cases the mother was smoking during the pregnancy, accounting for about 53% of premature births.
