...
**Notable Features:** The tone of a question, formatting, specificity, and ... seem to influence the score of a question. 

Answers which include examples, are of adequate length, with a positive tone, ... influence the score of a submission.

**Ideal question and answer:** Though our findings were not all conclusive, the ideal question should not be demanding, properly articulated, and ..

The ideal answer should be specific, with examples, long enough to sufficiently answer the question, with a positive tone, and ...
