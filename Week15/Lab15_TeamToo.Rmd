...
```
I want to write a function that filters the first variable and calculates the mean of the second but it keeps returning the following error message, does anyone have any ideas? 
