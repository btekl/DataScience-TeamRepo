...
ggplot() +
  ...
  geom_line(data = ff, aes(pop/1000000,predictions))+
  geom_line(data = ff, aes(pop/1000000, residuals))+
  ggtitle("Japan's GDP Compared to Population")+
  ylab("Population in Millions")+
  xlab("GDP per Capita")

```
This graph shows the relationship between Population and GDP to be exponential. The risudual line clearly illustrates the distance between each point.
