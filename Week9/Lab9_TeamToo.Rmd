...
* The favorite and least favorite candies are similar but display noticable differences between countries. All countries tend to hate the same candy and prefer chocolate over sour and sweet candy.
...
```
From this we can see that the United Kingdom's favorite candy Rolos is not seen as a favorite for United States and Canada. All the candies made up of chocolate as well for the United Kingdom and the United States, but Canada had smarties as one of thier favorite candies. Overall, the favorites and dislike are similar but there are differences that allow us to analyze the preferences of each country.
...
**Andrew:** I used a clean dataset to analyze the prefered and least favorite candies based upon which country the person was from.
